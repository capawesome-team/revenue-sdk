...
No. The Polar API has no idempotency-key mechanism, so a retried write may create a duplicate resource.
Retry reads freely; guard writes such as checkout creation with your own deduplication.
