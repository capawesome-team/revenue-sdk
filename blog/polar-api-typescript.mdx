...
The full list, with the capability table, is on the [Polar provider page](/docs/providers/polar).
...
- [Polar provider reference](/docs/providers/polar) — factory options, capabilities, and every quirk.
