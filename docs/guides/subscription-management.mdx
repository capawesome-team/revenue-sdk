...
I change?* — and offer four actions: cancel, uncancel, change plan, and manage billing details.
...
subscription and confirm `cancelAtPeriodEnd === false` before telling the customer it worked.
:::
